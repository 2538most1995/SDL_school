...
const StatisticsOverviewPage = lazyWithReload(async () => ({ default: (await import('./reports/StatisticsOverviewPage')).StatisticsOverviewPage }));
...
export const featureRouteCatalog: FeatureRoute[] = [
    ...
    { path: '/learning/exam-attendance-check', label: 'เช็คชื่อเข้าสอบ', roles: ['student', 'teacher', 'admin', 'super_admin'], element: <ExamAttendanceCheckPage /> },
