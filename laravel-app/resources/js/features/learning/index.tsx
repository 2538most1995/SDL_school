...
function ExamSchedulePage() {
    ...
    const openStandaloneSchedule = async () => {
        ...
        try {
            ...
            // Same-tab navigation still works when LINE blocks target="_blank" or refuses to render PDF.
            window.location.assign(url);
        } catch (error) {
            setPdfError(error instanceof Error ? error.message : 'ไม่สามารถเปิดตารางสอบได้');
