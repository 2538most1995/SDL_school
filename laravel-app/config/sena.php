    ...
    'modules' => [
        ...
        [
            ...
            'items' => [
                ...
                ['key' => 'exam-attendance-check', 'label' => 'เช็คชื่อเข้าสอบ', 'description' => 'ตรวจสอบสถานะการเข้าสอบรายวิชา หรือบันทึกการเข้าสอบพร้อมสรุปสถิติ', 'route' => '/learning/exam-attendance-check', 'icon' => 'clipboard', 'roles' => ['student', 'teacher', 'admin', 'super_admin']],
        ...
        [
            ...
            'items' => [
                ...
                ['key' => 'course-registration', 'label' => 'ลงทะเบียนเรียน', 'description' => 'เลือกลงทะเบียนรายวิชาและพิมพ์ใบลงทะเบียนเรียน (PDF)', 'route' => '/learning/registration', 'icon' => 'notebook', 'roles' => ['teacher', 'admin', 'super_admin']],
