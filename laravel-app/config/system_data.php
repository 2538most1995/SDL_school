...
return [
    ...
    'student_api_auth_rate_limit_per_minute' => max(1, (int) env('STUDENT_DATA_API_AUTH_RATE_LIMIT_PER_MINUTE', 20)),
    'student_api_rate_limit_per_minute' => max(1, (int) env('STUDENT_DATA_API_RATE_LIMIT_PER_MINUTE', 60)),
