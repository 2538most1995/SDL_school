...
11. งานที่มอบหมายเลือกได้เฉพาะรายวิชาลงทะเบียนในภาคเรียนปัจจุบันและขอบเขตกลุ่มของครู; การส่งงานใช้ `student_code` จากชุดข้อมูลผู้เรียนปัจจุบัน รองรับลิงก์หรือ PDF private storage และครูเห็น/ตรวจได้เฉพาะงานที่ตนสร้างภายในอำเภอ
