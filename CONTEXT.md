...
20. สถิตินักศึกษาลงทะเบียนนับนักศึกษาไม่ซ้ำที่มีรายการเกรด/ลงทะเบียนในภาคเรียนที่เลือกจาก batch ล่าสุดของอำเภอ แยกและกรองร่วมกันได้ตาม `grp_code`/ชื่อกลุ่ม (กลุ่มเรียน), `occtyp` (กลุ่มเป้าหมาย), `gender`, ระดับตาราง 1–3, `occp` (อาชีพ), `nation` (สัญชาติ) และ `age` (อายุ) พร้อมยอดรวมท้ายตาราง; ครูเห็นเฉพาะกลุ่มที่ได้รับมอบหมาย และนักศึกษาไม่มีสิทธิ์เข้ารายงานนี้; การส่งออก Excel ใช้ข้อมูลตามภาคเรียนและตัวกรองเดียวกับหน้าจอ โดย endpoint สำหรับส่งออกอนุญาตเฉพาะ `teacher` และ `admin`
