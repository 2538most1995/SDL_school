...
23. เมนู `สถิติ` รวมเป็นหน้า `รายงานสถิติ` ที่ `/reports/overview` โดยมีสารสนเทศรวม ตัวเลือกรายงาน 15 รายการ การจำแนกแนวตั้ง/แนวนอน ตัวอย่างก่อนพิมพ์ การพิมพ์ และ Excel; การตั้งค่ามิติแนวตั้งและแนวนอนต้องจัดเก็บแยกกัน การเพิ่ม/ลบมิติด้านหนึ่งต้องไม่กระทบอีกด้าน และตาราง/ไฟล์ส่งออกต้องแสดงสรุปท้ายตารางด้วยยอดรวมผู้เรียนไม่ซ้ำจากข้อมูลต้นทาง; ต้องใช้เฉพาะ API รายงานที่มีข้อมูลต้นทางยืนยันแล้ว ห้ามนำข้อมูลรายงานอื่นมาสวมแทนรายการรักษาสภาพ หมดสภาพ ลาออก หรือสถานะที่ยังแยกไม่ได้ และต้องแสดงเหตุผลว่า “รอข้อมูลต้นทาง” แทนการสร้างตัวเลขจำลอง; ระดับจังหวัดและช่วงมากกว่าหนึ่งภาคเรียนยังไม่ประมวลผลจนกว่าจะมี API รวมข้ามอำเภอ/ช่วงเวลา
