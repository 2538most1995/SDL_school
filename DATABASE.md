...
- `learning_assignments`: district, creator, academic term, subject code/name, education level, title/instructions, target type/value, score, open/due timestamps, status; index (`district_id`, `status`, `due_at`)
